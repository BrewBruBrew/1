...
# Apply frequency domain LPF
lpf_window_type = 'hann'
lpf_taps = 256
shaped_signals = {name: apply_freq_domain_lpf(base_pulse * env, lpf_window_type, lpf_taps)
